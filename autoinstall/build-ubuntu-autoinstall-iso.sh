...
autoinstall:
  ...
  late-commands:
    ...
    - |
      curtin in-target --target=/target -- sh -c '
        ...
        if [ -n "\$IP" ]; then
            ...
            ipmitool raw 0x0a 0x44 0x00 0x00 0x02 0x00 0x00 0x00 0x00 0x21 0x00 0x04 0x12 0x00 0x6f 0x03 \$h1 \$h2 2>/dev/null || true
            sleep 5
            # Part 2: IP Octets 3.4 (236.120)
            ipmitool raw 0x0a 0x44 0x00 0x00 0x02 0x00 0x00 0x00 0x00 0x21 0x00 0x04 0x12 0x00 0x6f 0x04 \$h3 \$h4 2>/dev/null || true
    ...
    - sleep 1
    - curtin in-target --target=/target -- sh -c 'ipmitool raw 0x0a 0x44 0x00 0x00 0x02 0x00 0x00 0x00 0x00 0x21 0x00 0x04 0x12 0x00 0x6f 0xaa 0x00 0x00 || true'
    - sleep 1
    ...
    - |
      curtin in-target --target=/target -- sh -c '
        ...
        if [ "\$actual_serial" = "\$expected_serial" ]; then
            ...
            ipmitool raw 0x0a 0x44 0x00 0x00 0x02 0x00 0x00 0x00 0x00 0x21 0x00 0x04 0x12 0x00 0x6f 0x05 0x4f 0x4b 2>/dev/null || true
        else
            ...
            ipmitool raw 0x0a 0x44 0x00 0x00 0x02 0x00 0x00 0x00 0x00 0x21 0x00 0x04 0x12 0x00 0x6f 0x05 0x45 0x52 2>/dev/null || true
        fi
      '
EOF
